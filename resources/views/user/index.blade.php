        ...
        <div class="card card-primary card-outline card-outline-tabs">
            ...
            <div class="card-body">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            @csrf
                                ...
                                <div class="form-group mb-3">
                                    <label>Jabatan:</label>
                                    <select name="position_id" class="form-control" required placeholder="Role" required>
                                        <option value="">-- Pilih Jabatan --</option>
                                        @foreach ($positions as $pos)
                                            <option value="{{$pos->id}}">{{$pos->department_name.' - '.$pos->position_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        </div>
                ...
                <table id="dataTableExample" class="table table-stripe">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Department / Jabatan</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>{{ $user->role }}</td>
                            <td>{{ $user->department_name.' / '.$user->position_name }}</td>
                            <td>
                                ...
                                <div class="modal-body">
                                    ...
                                    @method('patch')
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="position_id" class="form-control" required placeholder="Role">

                                                <option value="">-- Pilih Jabatan --</option>

                                                @foreach ($positions as $pos)
                                                    <option value="{{$pos->id}}" @php echo ($user->position_id == $pos->id) ? 'selected' : '' ; @endphp>{{$pos->position_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                </div>
                ...
                <div class="tab-pane fade" id="archive" role="tabpanel" aria-labelledby="archive-tab">
                    <table id="dataTableExample2" class="table table-stripe">
                        <thead>
                            <tr>
                                <th scope="col">No.</th>
                                <th scope="col">Nama User</th>
                                        ...
                                        @method('patch')
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="role" class="form-control" required placeholder="Role">
                                                    ...
                                                    <option @if ($user_arc->role == 'user') selected @endif value="user">User</option>
                                                </select>
                                            </div>
                                    </div>
                                    <div class="modal-footer">
